# Как изучить Жава и получать 70-160

Прежде чем изучать нужно определится - а нужно ли вам это, узнать что именно вы получите и сколько усилий и
...
Если все-же вы не смогли найти человека к которому сможете обратится за советом (это херово, прибавляйте себе сразу неск.
...
Если вы можете хотя-бы читать по английски - постарайтесь использовать только английские учебники, ресурсы и материалы.
...
- Науцится использовать IDE IntelliJ IDEA (начинайте сразу, она нужна для решения примеров из книги).

В жава есть три части:

- Java SE - сам язык и основная платформа, именно его вы изучите в книге (1 том), нужно знать хорошо.
- Java EE - она вам не нужна, еще можно встретить в вакансиях, но, если только она не нужна вам по работе,
просто так, "на будущее" ее не изучайте (если не ошибаюсь это вророй том книги, он вам не нужен).
...
Вакансии нужно искать в компаниях с деньгами - это банки, нефте-газовый сектор, телеком, оутсорсинговые конторы.
...
Английский как минимум свободное чтение и письмо, желательно также разговорный боль-менее.
